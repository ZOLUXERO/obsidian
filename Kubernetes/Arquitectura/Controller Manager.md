Basicamente el controller manager tiene la finalidad de estar pendiente, monitorear y responder por el status de su respectiva tarea sea nodo, replica, deployment etc.
